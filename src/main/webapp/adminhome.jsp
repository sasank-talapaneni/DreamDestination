    ...
    <div class="content flex_space">
      ...
      <div class="navlinks">
        <ul id="menulist">
         ...
         <li><a href="adminhotelsandtours"><i class="fa fa-hotel" style="font-size:24px"></i>Hotels&Tours</a></li>
         <li><a href="viewallusers"><i class="fa fa-user" style="font-size:24px"></i> Management</a></li>

      <li><a href="contact.jsp"><i class="fa fa-envelope" style="font-size:24px"></i> Support</a></li>

         <li> <a href="index.jsp">Logout<i class='fas fa-user-alt' style='font-size:24px'></i></a></li>
         <h3 align="centre" >Welcome Admin</h3>
        </ul>
