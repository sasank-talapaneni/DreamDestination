...
<body>
 <header>
    ...
    <div class="tour-section">
      <div class="content">
        <span class="blink">
          <h3 align="center" style="color:red">${tourMessage}</h3>
        </span>
        <br>
        <h2>Tour Login</h2>
        <form method="post" action="checktourlogin">
          <div>
            <input type="text" name="tourUsername" placeholder="Tour Username" required /><br />
            <input type="password" name="tourPassword" placeholder="Tour Password" required /><br />
            <button><input type="submit" value="Tour Login"></button>
          </div>
        </form>
      </div>
    </div>
