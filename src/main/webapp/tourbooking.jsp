...
<form class="hotel-reservation-form" method="post" action="reservetour">
    <h1><i class="far fa-calendar-alt"></i>Tour Reservation</h1>
    <div class="fields">
        <!-- Input Elements -->
        <div class="wrapper">
        <div>
...
<label for="veh_pref">Vehicle Preference</label>
<div class="field">
<select id="veh_pref" name="veh_pref" required>
<option disabled selected value="">--</option>
<option value="Car">Car/Taxi</option>
<option value="Small Coach">Small Coach</option>
<option value="Coach">Coach</option>
</select>
</div>
<label for="room_pref">Hotel Room Preference</label>
<div class="field">
...
<div class="field">
<textarea placeholder="Plan of your tour preferences/places"></textarea>
</div>
