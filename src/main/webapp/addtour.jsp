...
<body>
    ...
    <header>
        <div class="content flex_space">
          ...
          <div class="navlinks">
            <ul id="menulist">
             <li><a href="tourhome.jsp"><i class="fa fa-home" style="font-size:24px"></i></a> </li>
          <li><a href="viewalltoursinfoadmin"><i class='fas fa-route' style='font-size:24px'></i></a> </li>
		     <li><a href="login.jsp"><i class="fa fa-sign-in" style="font-size:24px"></i></a> </li>
            </ul>
            <span class="fa fa-bars" onclick="menutoggle()"></span>
          </div>
          <div class="add-hotel-button">
                <a href="tourform.jsp" class="primary-btn">Add Tour</a>
            </div>
        </div>
      </header>
         ...
         <c:forEach items="${tourslist}" var="tour">
          <div class="items">
            ...
            <div class="text">
              ...
              <h2><c:out value="${tour.type}"></c:out></h2>
              <h2>Start :<c:out value="${tour.startdate}"></c:out></h2>
              <h2>End :<c:out value="${tour.enddate}"></c:out></h2>
              <div class="rate flex">
              ...
              <div class="button flex">
                 <a class="primary-btn" href="deletetour?tourId=${tour.id}">DELETE</a>
